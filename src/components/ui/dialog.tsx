...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn('text-xs font-medium text-muted-foreground leading-relaxed', className)}
    {...props}
  />
));
